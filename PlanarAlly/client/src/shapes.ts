...
export function Rect(x, y, w, h, fill?, border?, uuid?): void {
    Shape.call(this);
    this.type = "rect";
    this.x = x || 0;
    this.y = y || 0;
...
export function Circle(x, y, r, fill?, border?, uuid?): void {
    Shape.call(this);
    this.type = "circle";
    this.x = x || 0;
    this.y = y || 0;
...
export function Line(x1, y1, x2, y2, uuid?): void {
    Shape.call(this);
    this.type = "line";
    this.x1 = x1;
    this.y1 = y1;
...
export function Text(x, y, text, font, angle?, uuid?) {
    Shape.call(this);
    this.type = "text";
    this.x = x;
    this.y = y;
...
export function Asset(img, x, y, w, h, uuid?): void {
    Shape.call(this);
    this.type = "asset";
    this.uuid = uuid || uuidv4();
    this.img = img;
