...
socket.on("Shape.Options.Invisible.Set", wrapCallOld(Shape.prototype.setInvisible));
socket.on("Shape.Options.Locked.Set", wrapCallOld(Shape.prototype.setLocked));
socket.on("Shape.Options.Token.Set", wrapCallOld(Shape.prototype.setIsToken));
socket.on("Shape.Options.MovementBlock.Set", wrapCallOld(Shape.prototype.setMovementBlock));
socket.on("Shape.Options.VisionBlock.Set", wrapCallOld(Shape.prototype.setVisionBlock));
socket.on("Shape.Options.Annotation.Set", wrapCallOld(Shape.prototype.setAnnotation));
socket.on("Shape.Options.Name.Set", wrapCallOld(Shape.prototype.setName));
socket.on("Shape.Options.NameVisible.Set", wrapCallOld(Shape.prototype.setNameVisible));
socket.on("Shape.Options.StrokeColour.Set", wrapCallOld(Shape.prototype.setStrokeColour));
socket.on("Shape.Options.FillColour.Set", wrapCallOld(Shape.prototype.setFillColour));
socket.on("Shape.Options.ShowBadge.Set", wrapCallOld(Shape.prototype.setShowBadge));
