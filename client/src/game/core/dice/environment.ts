...
export async function loadDiceEnv(): Promise<DiceThrower> {
    ...
    (self as any).shadowGenerator = new ShadowGenerator(1024, light);
    ...
    // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access
    (self as any).diceThrower = diceThrower;
    // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access
    (self as any).Dice = Dice;
    // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access
    (self as any).p = dndParser;
    // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access
    (self as any).V3 = Vector3;
    // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access
    (self as any).r = async (inp: string, options?: DieOptions[]): Promise<void> => {
