        ...
        if (!this.valid) {
            ...
            if (
                ...
                for (let f = floorState.readonly.floors.length - 1; f > floorState.readonly.floorIndex; f--) {
                    ...
                    this.vCtx.drawImage(fowl.canvas, 0, 0, this.canvasWidth, this.canvasHeight); // window.innerWidth, window.innerHeight);
                    ...
                    this.vCtx.drawImage(mapl.canvas, 0, 0, this.canvasWidth, this.canvasHeight); // window.innerWidth, window.innerHeight);
                }
                this.ctx.globalCompositeOperation = "source-over";
                this.ctx.drawImage(this.virtualCanvas, 0, 0, this.canvasWidth, this.canvasHeight); // window.innerWidth, window.innerHeight);
            }
