...
(self as any).drawPoint = drawPoint;
// eslint-disable-next-line @typescript-eslint/no-unsafe-member-access
(self as any).drawPointLocal = drawPointL;
// eslint-disable-next-line @typescript-eslint/no-unsafe-member-access
(self as any).drawLine = drawLine;
// eslint-disable-next-line @typescript-eslint/no-unsafe-member-access
(self as any).DE = drawEdge;
// eslint-disable-next-line @typescript-eslint/no-unsafe-member-access
(self as any).DP = drawPolygon;
// eslint-disable-next-line @typescript-eslint/no-unsafe-member-access
(self as any).DPL = drawPolygonL;
// eslint-disable-next-line @typescript-eslint/no-unsafe-member-access
(self as any).DPT = drawPolygonT;
// eslint-disable-next-line @typescript-eslint/no-unsafe-member-access
(self as any).showLayerPoints = showLayerPoints;
