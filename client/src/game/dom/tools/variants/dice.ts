...
import { diceStore } from "../../../core/dice/state";
...
class DiceTool extends Tool implements ITool {
    ...
    addShadow(die: Dice, mesh: Mesh): void {
        ...
        ((self as any).shadowGenerator as ShadowGenerator).addShadowCaster(mesh);
        // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access
        ((self as any).shadowGenerator as ShadowGenerator).useCloseExponentialShadowMap = true;
    }
}
