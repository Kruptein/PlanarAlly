...
import { sendBringPlayers } from "../../../core/api/emits/players";
import { getGlobalId, getLocalId } from "../../../core/id";
import { LayerName } from "../../../core/models/floor";
import { Asset } from "../../../core/shapes/variants/asset";
...
function bringPlayers(): void {
    ...
    sendBringPlayers({
        floor: floorState.readonly.currentFloor!.name,
...
async function createSpawnLocation(): Promise<void> {
    ...
    floorSystem
        .getLayer(floorState.readonly.currentFloor!, LayerName.Dm)!
