...
import { requestAssetOptions, sendAssetOptions } from "../../../core/api/emits/asset";
import { requestSpawnInfo } from "../../../core/api/emits/location";
import { sendShapesMove } from "../../../core/api/emits/shape/core";
import { getGlobalId, getShape } from "../../../core/id";
import type { LocalId } from "../../../core/id";
import type { ILayer } from "../../../core/interfaces/layer";
import { compositeState } from "../../../core/layers/state";
import type { AssetOptions } from "../../../core/models/asset";
import type { Floor, LayerName } from "../../../core/models/floor";
import { toTemplate } from "../../../core/shapes/templates";
...
import { groupSystem } from "../../../core/systems/groups";
...
import { moveFloor, moveLayer } from "../../../core/temp";
...
const layers = computed(() => {
    if (gameState.reactive.isDm && !selectionIncludesSpawnToken.value) {
        const currentFloor = floorState.readonly.currentFloor;
...
function setLayer(newLayer: LayerName): void {
    ...
    moveLayer(oldSelection, floorSystem.getLayer(floorState.readonly.currentFloor!, newLayer)!, true);
    close();
}
