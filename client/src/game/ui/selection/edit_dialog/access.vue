...
<template>
    <div style="display:contents">
        <div class="spanrow header" v-t="'Access'"></div>
        <div class="owner"><em v-t="'Default'"></em></div>
        <div
            :style="{
        ...
        <div
            ...
            :title="$t('Toggle movement access')"
        >
