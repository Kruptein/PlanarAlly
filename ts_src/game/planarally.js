...
export const vm = new Vue({
    ...
    methods: {
        mousedown(event) { this.$refs.tools.mousedown(event); },
        mouseup(event) { this.$refs.tools.mouseup(event); },
        mousemove(event) { this.$refs.tools.mousemove(event); },
        contextmenu(event) { this.$refs.tools.contextmenu(event); },
        selectLayer(layer) {
